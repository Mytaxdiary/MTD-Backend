    ...
    <tr><td align="center">
      <table ${CARD}>
        <tr><td>
          ...
          <h1 style="margin:0 0 20px;font-size:22px;color:#111827;font-weight:700">You are invited to join ${opts.firmName}</h1>
          <p style="margin:0 0 24px;font-size:14px;color:#374151;line-height:1.6">
            Hi ${opts.firstName}, you have been invited to join <strong>${opts.firmName}</strong> on My Tax Diary.
            Click the button below to set your password and create your account. This link is valid for <strong>7 days</strong>.
          </p>
          <a href="${opts.inviteUrl}" ${BTN}>Accept invitation</a>
          <p style="margin:24px 0 0;font-size:12px;color:#9ca3af;line-height:1.6">
            If you were not expecting this invitation, you can ignore this email.<br>
...
export function staffInvitePlainText(opts: {
  firstName: string;
  firmName: string;
  inviteUrl: string;
}): string {
  return `Hi ${opts.firstName},\n\nYou have been invited to join ${opts.firmName} on My Tax Diary.\nSet your password here (valid 7 days):\n\n${opts.inviteUrl}\n\nIf you were not expecting this, ignore this email.`;
}
